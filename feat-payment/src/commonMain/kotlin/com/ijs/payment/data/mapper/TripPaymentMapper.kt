...
private val log = Logger.withTag("TripPaymentMapper")
...
object TripPaymentMapper {
    ...
    fun TripPaymentDto.toDomain(): TripPayment {
        ...
        log.d { "Mapping payment id=$id: tripId=$resolvedTripId, customerName='$resolvedCustomerName', customerCompany='$resolvedCustomerCompany'" }
