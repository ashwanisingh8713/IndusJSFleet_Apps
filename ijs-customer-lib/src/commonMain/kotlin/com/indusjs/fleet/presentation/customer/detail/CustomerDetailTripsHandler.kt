...
import com.indusjs.fleet.presentation.customer.detail.CustomerDetailContract.TripStateFilter
...
class CustomerDetailTripsHandler(
    ...
    suspend fun loadTrips(customerId: String) {
        ...
        log.d { "loadTrips: Starting load for customer $customerId, filter: ${getState().tripStateFilter}" }
