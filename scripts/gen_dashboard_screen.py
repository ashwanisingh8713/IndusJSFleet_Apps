...
content = '''package com.ijs.dashboard.presentation
...
# Fix the escaped string interpolation 
content = content.replace('$\\{formatLastUpdated(lastUpdated)}', '${formatLastUpdated(lastUpdated)}')

path = '/Users/ashwani/KotlinMultiplateform/IndusJSFleet/feat-dashboard/src/commonMain/kotlin/com/ijs/dashboard/presentation/DashboardScreen.kt'
with open(path, 'w') as f:
    f.write(content)
print(f'Written {os.path.getsize(path)} bytes, {content.count(chr(10))} lines')
