...
import com.ijs.driver.TAG_DRIVER_REPO
    ...
    override suspend fun createDriver(driver: Driver): Result<Driver> {
        return try {
            ...
            if (response.success && data != null) {
                ...
                logger.e(TAG_DRIVER_REPO, "Create driver failed: $errorMessage")
                Result.Error(ApiException(errorMessage), errorMessage)
            }
        } catch (e: Exception) {
            logger.e(TAG_DRIVER_REPO, "Exception creating driver: ${e.message}", e)
            Result.Error(e, ApiErrorHandler.extractErrorMessage(e))
        }
    }
