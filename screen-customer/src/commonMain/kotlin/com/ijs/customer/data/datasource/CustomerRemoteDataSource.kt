...
import com.ijs.customer.TAG_CUSTOMER_REMOTE_DS
...
class CustomerRemoteDataSource(
    ...
    suspend fun getCustomers(
        ...
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Response: $responseText")
    ...
    suspend fun getCustomer(token: String, customerId: Int): CustomerResponse {
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Fetching customer: $customerId")
    ...
    suspend fun createCustomer(token: String, request: CreateCustomerRequest): CustomerResponse {
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Creating customer: ${request.companyName}")
    ...
    suspend fun updateCustomer(
        ...
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Updating customer: $customerId")
    ...
    suspend fun getCustomerTrips(
        ...
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Fetching customer trips: $customerId, page: $page, state: $state")
        ...
        val responseText = response.bodyAsText()
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Response: ${responseText.take(500)}...")
    ...
    suspend fun getCustomerPendingPayments(
        ...
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Fetching customer pending payments: $customerId, page: $page")
    ...
    suspend fun getCustomerPayments(
        ...
        logger.d(TAG_CUSTOMER_REMOTE_DS, "Fetching customer payments: $customerId, page: $page, mode: $mode")
