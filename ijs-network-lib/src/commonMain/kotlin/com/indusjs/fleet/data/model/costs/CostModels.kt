    ...
    val groups: List<CostTypeGroupDto> = listOf(
        ...
        CostTypeGroupDto(
            ...
            items = listOf(
                ...
                CostTypeItemDto("TC-004-002", "TC-004-002", "Driver Food"),
                CostTypeItemDto("TC-004-003", "TC-004-003", "Driver Accommodation")
            )
        ),
        CostTypeGroupDto(
            groupId = "TC-G-005",
            ...
            items = listOf(
                ...
                CostTypeItemDto("TC-005-003", "TC-005-003", "Special Permit"),
                CostTypeItemDto("TC-005-004", "TC-005-004", "Chalan / Fine")
            )
        ),
        CostTypeGroupDto(
            groupId = "TC-G-006",
            ...
            items = listOf(
                ...
                CostTypeItemDto("TC-006-002", "TC-006-002", "Weighbridge"),
                CostTypeItemDto("TC-006-003", "TC-006-003", "Commission / Brokerage"),
                CostTypeItemDto("TC-006-004", "TC-006-004", "Other")
            )
        )
    )
}
...
object MaintenanceCostTypes {
    ...
    val groups: List<CostTypeGroupDto> = listOf(
        CostTypeGroupDto(
            ...
            items = listOf(
                CostTypeItemDto("VMC-001-001", "VMC-001-001", "Engine Oil Change"),
                CostTypeItemDto("VMC-001-002", "VMC-001-002", "Oil Filter Replacement"),
                CostTypeItemDto("VMC-001-003", "VMC-001-003", "Air Filter Replacement"),
                CostTypeItemDto("VMC-001-004", "VMC-001-004", "Wheel Alignment & Balancing"),
                CostTypeItemDto("VMC-001-005", "VMC-001-005", "General Servicing Labor")
            )
        ),
        CostTypeGroupDto(
            groupId = "VMC-G-002",
            ...
            items = listOf(
                CostTypeItemDto("VMC-002-001", "VMC-002-001", "Brake Pads / Discs"),
                CostTypeItemDto("VMC-002-002", "VMC-002-002", "Battery Replacement"),
                CostTypeItemDto("VMC-002-003", "VMC-002-003", "Tyres Replacement"),
                CostTypeItemDto("VMC-002-004", "VMC-002-004", "Clutch Repair"),
                CostTypeItemDto("VMC-002-005", "VMC-002-005", "Suspension Repair")
            )
        )
    )
}
...
data class CostTypeCategoryDto(
     ...
     */
    fun toCostTypeGroups(): List<CostTypeGroupDto> {
        return groups.map { group ->
            CostTypeGroupDto(
                groupId = group.groupId,
                groupName = group.groupName,
                items = group.items.map { item ->
                    CostTypeItemDto(id = item.value, value = item.value, label = item.label)
                }
            )
        }
    }
